...
public class SoundExtension extends AndroidNonvisibleComponent
...
  public SoundExtension(ComponentContainer container) {
...
        if (granted) {
          SoundExtension.this.Source(tempPath);
        } else {
          form.dispatchPermissionDeniedEvent(SoundExtension.this, "Source", permission);
        }
      }
    })) {
      return;
...
      defaultValue = "1")
  @SimpleProperty
  public void PlaybackRate(float pbRate) {
    playbackRate = pbRate;
  }
